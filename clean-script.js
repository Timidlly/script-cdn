...
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="527.937px" height="527.937px" viewBox="0 0 527.937 527.937" style="enable-background:new 0 0 527.937 527.937;"
	 xml:space="preserve">
<g>
	<path d="M525.738,127.774l-9.013-6.438c-0.107-0.077-0.224-0.124-0.331-0.196c-0.126-0.073-0.242-0.145-0.373-0.21
		...
		h-4.779V457.573z M189.013,457.573h-16.129v-4.779h16.129V457.573z" class="brainPath"/>
</g>
</svg>
...
`
          ...
          function neuralize() {
          document.querySelector(".cleanContainer").innerHTML = "";
          document.querySelector(".cleanContainer").innerHTML = svg;
          animateSVGs();
          ...
          document.querySelector(".cleanContainer").addEventListener("click", function(){setColors("dark")});
